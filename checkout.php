   ...
   <section class="checkout">
      ...
      <form action="" method="post">
         ...
         <div class="cart-items">
            ...
            ?>
                  <p><span class="name"><?= $fetch_cart['name']; ?></span><span class="price"><?= $fetch_cart['price'] ?>VND x <?= $fetch_cart['quantity']; ?></span></p>
            <?php
               }
            } else {
            ...
            ?>
            <p class="grand-total"><span class="name">grand total :</span><span class="price"><?= $grand_total ?>VND</span></p>
