...
if (isset($_POST['submit'])) {
   ...
   $address = $_POST['building'] . ', ' . $_POST['street'] . ', ' . $_POST['ward'] . ', ' . $_POST['district'] . ', ' . $_POST['city'] . ', ' . $_POST['country'];
...
<body>
   ...
   <section class="form-container">
      ...
      <form action="" method="post">
         <h3>your address</h3>
         <input type="text" class="box" placeholder="flat of building no." required maxlength="50" name="building">
         <input type="text" class="box" placeholder="street name" required maxlength="50" name="street">
         <input type="text" class="box" placeholder="ward name" required maxlength="50" name="ward">
